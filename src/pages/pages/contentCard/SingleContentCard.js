...
const SingleContentCard = () => {
  ...
  return (
    <div className=" p-1 lg:p-2 w-11/12 m-auto lg:w-7/12">
      <div className="container mx-auto">
        <Card>
          <div
            style={{
              backgroundImage: `url(${singleContent?.photoLink})`,
              backgroundPosition: "center",
              opacity: "80%",
            }}
          >
            <div className="h-96 rounded-md w-[100%] bg-black opacity-25"></div>
          </div>
